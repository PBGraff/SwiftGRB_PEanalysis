...
double qromb2(double (*func)(double), double a, double b);
...
double qsimp1(double (*func)(double), double a, double b);
...
//float select(unsigned long k, unsigned long n, double arr[]);
